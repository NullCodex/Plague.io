 ...
 * @param {Array} cityCards - An array of the list of cityCards uuids
 */

function setupPlayer(playerNames, washingtonUuid, cityCards) {
    ...
    var shuffledCards = shuffle(cityCards);
